...
tinymce.html.Styles = function (d, f)
{
    ...
    return {
        ...
        {
            var y = {},
                p, n, v, q, u = d.url_converter,
                x = d.url_converter_scope || this;
...
(function (l)
{
    ...
    l.html.Schema = function (p)
    {
        ...
        function r(F)
        {
            var E, A, T, P, U, z, C, O, R, K, S, W, I, D, Q, y, M, B, V, X, J, N, H = /^([#+-])?([^\[\/]+)(?:\/([^\[]+))?(?:\[([^\]]+)\])?$/,
                L = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/,
                G = /[*?+]/;
            if (F)
            {
    ...
    a.html.SaxParser = function (c, e)
    {
        ...
        b.parse = function (q)
        {
            var A = this,
                f, m = 0,
                G, j, l = [],
                B, K, t, N, F, k, p, x, I, r, E, o, J, n, H, M, L, z, D, h, g, u, s = 0,
                v = a.html.Entities.decode,
                y;
...
(function (b)
{
    ...
    b.html.DomParser = function (g, h)
    {
        ...
        {
            var n, F, z, y, B, A, v, q, D, I, x, o, C, H = [],
                s, k, r, p, t;
            m = m || {};
            i = {};
            c = {};
...
(function (h)
{
    var f = h.each,
        ...
        c = h.html.Entities,
        a = /^([a-z0-9],?)+$/i,
        g = h.html.Schema.blockElementsMap,
        i = /^[ \t\r\n]*$/;
        ...
        getBookmark: function (r, s)
        {
            ...
            if (r == 2)
            {
                function k()
                {
                    ...
                    function z(C, H)
                    {
                        var B = C[H ? "startContainer" : "endContainer"],
                            G = C[H ? "startOffset" : "endOffset"],
                            A = [],
                            D, F, E = 0;
                        if (B.nodeType == 3)
                        {
...
(function (m)
{
    ...
    m.create("tinymce.Editor", {
        ...
        init: function ()
        {
            ...
            {
                var I = c.get(H),
                    t = c.urls[H] || m.documentBaseURL.replace(/\/$/, ""),
                    s;
                if (I)
                {
                    s = new I(F, t);
        ...
        setupIframe: function ()
        {
            ...
            {
                var B = t.length,
                    C, s = r.schema.getNonEmptyElements();
                while (B--)
                {
                    C = t[B];
                    if (C.isEmpty(s))
        ...
        setContent: function (t, s)
        {
            ...
            if (s.format !== "raw")
            {
                t = new m.html.Serializer(
                {}, r.schema).serialize(r.parser.parse(t))
            }
            s.content = m.trim(t);
        ...
        t(
        {
            ...
            mceInsertContent: function (z, D, E)
            {
                ...
                while (C)
                {
                    if (C === x)
                    {
                        l.setOuterHTML(F, new c.html.Serializer(
                        {}, n.schema).serialize(n.parser.parse(l.getOuterHTML(F))));
                        break
                    }
                    F = C;
                    C = C.parentNode
    ...
    l.create("tinymce.ForceBlocks", {
        ...
        setup: function ()
        {
            ...
            if (p.force_p_newlines)
            {
                ...
                else
                {
                    ...
                    m.onKeyUp.add(function (t, v)
                    {
                        ...
                        {
                            var u = t.selection.getStart(),
                                s = n._previousFormats;
            ...
            if (l.isWebKit)
            {
                ...
                {
                    var s = o.getRng(),
                        u, y = r.create("div", null, " "),
                        x, v = r.getViewPort(t.getWin()).h;
        ...
        {
            var o = this.editor,
                m = o.getDoc().createTreeWalker(u, 4, null, g),
                r = -1;
            while (u = m.nextNode())
            {
                r++;
        ...
        insertPara: function (R)
        {
            var F = this,
                ...
                H = G.getRangeAt(0),
                V = S.body;
            var K, L, I, P, O, q, o, u, z, m, D, U, p, x, J, M = N.getViewPort(v.getWin()),
                C, E, B;
...
(function (a)
{
    a.Formatter = function (V)
    {
        var M = {},
            ...
            q = V.selection,
            t = a.dom.TreeWalker,
            K = new a.dom.RangeUtils(c),
            d = V.schema.isValidChild,
            F = c.isBlock,
            l = V.settings.forced_root_block,
            s = c.nodeIndex,
            E = "\uFEFF",
            e = /^(src|href|style)$/,
            S = false,
        ...
        function T(Y, af, aa)
        {
            var ab = R(Y),
                ag = ab[0],
                ae, X, ad, ac = q.isCollapsed();

            function Z(ak)
            {
                var aj = ak.startContainer,
                    an = ak.startOffset,
                    am, al;
            ...
            function ah(ak)
            {
                ...
                K.walk(ak, function (an)
                {
                    ...
                    function ap(aq)
                    {
                        var au = aq.nodeName.toLowerCase(),
                            at = aq.parentNode.nodeName.toLowerCase(),
                            ar;
                        if (g(au, "br"))
                        {
                            ao = 0;
        ...
        function A(Y, ah, ab)
        {
            ...
            function ae(an)
            {
                var am = c.get(an ? "_start" : "_end"),
                    al = am[an ? "firstChild" : "lastChild"];
                if (H(al))
                {
